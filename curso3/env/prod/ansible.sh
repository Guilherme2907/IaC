#!/bin/bash
cd /home/ubuntu
sudo apt update -y > log-update.txt
sudo apt install -y python3-pip > log-pip.txt
sudo curl http://bootstrap.pypa.io/get-pip.py -o get-pip.py
sudo python3 get-pip.py > log-get.txt
sudo python3 -m pip install ansible > log-ansible.txt
